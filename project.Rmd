...
# Introduction
The objective of this project is to perform an **anlysis of Gun Violence in US** in the past decade. The statistics have as their main purpose giving a good overview of the and discovering trends and correlations between several factors and gun violence.
...
The differences between the states are generally not that significant, the percentages for each age group are somewhere around 25-40%. However, we notice one glaring exception for the state of Texas which has the highest percentage of children involved in gun-violence incidents (around 60%).
...
```{r}
r_location <- py$locationTypeTotal
