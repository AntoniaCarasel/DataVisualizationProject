...
lollipop_function(r_source, r_news, "The most trustful online newspepers that report gun-violence incidents")
```
...
lollipop_function(r_source, r_news, "The least trustful online newspepers that report gun-violence incidents")
```
...
print(np.array(incidentsPerState.index))
print(np.array(incidentsPerState.values))
...
spdf_fortified <- data.frame(
  id = spdf_fortified$id, long = spdf_fortified$long, lat = spdf_fortified$lat, order = spdf_fortified$order, 
  hole = spdf_fortified$hole, piece = spdf_fortified$piece, group = spdf_fortified$group, incidents = spdf_fortified$incidents
)
