...
```{python}
maleDistribution = fullsetDF[["state", "YEAR", "MALES"]]
maleDistribution = maleDistribution.groupby([maleDistribution["state"], maleDistribution["MALES"]], as_index=False).agg({"MALES" : "sum"})

femaleDistribution = fullsetDF[["state", "YEAR", "FEMALES"]]
femaleDistribution = femaleDistribution.groupby([femaleDistribution["state"], femaleDistribution["FEMALES"]], as_index=False).agg({"FEMALES" : "sum"})
