...
```{python}
peopleAggregatedByDate = fullsetDF[["date", "MONTH", "YEAR", "n_killed", "n_injured", "NO OF GUNS"]]
...
peopleAggregatedByDate = peopleAggregatedByDate.groupby([peopleAggregatedByDate["YEAR"], peopleAggregatedByDate["MONTH"] ], as_index=False)\
    .agg({"n_killed" : "sum", "n_injured" : "sum", "NO OF GUNS" : "sum", "date": np.max}).sort_values("date", ascending=True)

timeSeriesKilled = peopleAggregatedByDate[["date", "n_killed"]]
timeSeriesInjured = peopleAggregatedByDate[["date", "n_injured"]]
timeSeriesGuns = peopleAggregatedByDate[["date", "NO OF GUNS"]]
...
timeSeriesGuns = pd.DataFrame({
    ...
    "variable": n_guns,
    "value": timeSeriesGuns["NO OF GUNS"].to_numpy()
})
...
```{r}
r_date = py$timeSeriesInjured["date"]
r_value = py$timeSeriesInjured["value"]
